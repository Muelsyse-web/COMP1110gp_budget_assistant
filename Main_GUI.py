...
class FinanceApp:
    ...
    def setup_ui(self):
        ...
        bg_color = "#e0f2f7"  # Light blue background color
        
        # Apply the background color to the main window and all ttk components
        ...
        self.scale_cb = ttk.Combobox(top_frame, textvariable=self.scale_var, values=["All", "Year", "Month", "Day"], state="readonly", width=8)
        self.scale_cb.pack(side="left", padx=5)
        ...
        # Tag configuration for colors (Table row backgrounds)
    ...
    def add_record(self):
        ...
        win.grab_set()
        win.configure(bg="#e0f2f7")

        ttk.Label(win, text="Type:", background="#e0f2f7").pack(pady=(10, 0))
        ...
        ttk.Label(win, text="Date (YYYY-MM-DD):", background="#e0f2f7").pack(pady=(5, 0))
        ent_date = ttk.Entry(win)
        ent_date.pack()

        ttk.Label(win, text="Category:", background="#e0f2f7").pack(pady=(5, 0))
        ent_cat = ttk.Entry(win)
        ent_cat.pack()

        ttk.Label(win, text="Amount ($):", background="#e0f2f7").pack(pady=(5, 0))
        ent_money = ttk.Entry(win)
        ent_money.pack()

        ttk.Label(win, text="Description:", background="#e0f2f7").pack(pady=(5, 0))
    ...
    def set_limit(self):
        ...
        ttk.Label(win, text="Limit Type:", background="#e0f2f7").pack(pady=(10, 0))
        ...
        ttk.Label(win, text="Key (e.g. 'm' for month, or 'Food'):", background="#e0f2f7").pack(pady=(10, 0))
        ent_key = ttk.Entry(win)
        ent_key.pack()
        ttk.Label(win, text="Time keys: d(Day), w(Week), m(Month), y(Year)", font=("Arial", 8), background="#e0f2f7").pack()

        ttk.Label(win, text="Limit Amount ($):", background="#e0f2f7").pack(pady=(10, 0))
